...
**Thinking Mode**: When enabled (⚡ Thinking), the model uses extended thinking for better reasoning on complex tasks. The status appears on the right side of your prompt.
