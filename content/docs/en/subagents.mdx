...
For complex workflows requiring coordination, use the Team system:

```
Create a team to build a full-stack feature
```
...
- Persistent collaboration domains
...
Background shell tasks (from `run_in_background` in Bash) are managed via `/tasks`.
